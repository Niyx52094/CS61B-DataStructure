...
public class RunIterator implements Iterator {
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
	  ...
	  runArray[0]=pointer.count;
	  runArray[1]=pointer.value.red;
	  runArray[2]=pointer.value.green;
	  runArray[3]=pointer.value.blue;
	  if(this.hasNext()) {
  ...
  /**
   * this method is used in Part IV. setPixel(),as a pointer node.
   * @return the current Run that iterator points.
   */
