...
public class Tree234 extends IntDictionary {
  ...
  public void insert(int key) {
	  if(!find(key)) {
		  ...
		  while (node != null) {
			  if(node.keys==3) {
				  Tree234Node leftChild=new Tree234Node(node.key1);
				  Tree234Node rightChild=new Tree234Node(node.key3);
				  ...
				  if(node.equals(root)) {
					  Tree234Node node2=new Tree234Node(null,node.key2);
					  leftChild.parent=node2;
					  rightChild.parent=node2;
					  root=node2;
					  node.parent=root;
					  node2.child1=leftChild;
					  node2.child2=rightChild;
					  ...
					  if(node.key2<node.parent.key1) {
						  ...
						  node.parent.child2=rightChild;
						  node.parent.child1=leftChild;
					  }else if(node.parent.keys==1){
						  node.parent.key2=node.key2; 
						  node.parent.child2=leftChild;
						  node.parent.child3=rightChild;
						  ...
						  node.parent.child3=leftChild;
						  node.parent.child4=rightChild;
					  }
					  node.parent.keys++;
		  ...
		  if(root==null) {
			  ...
			  //insert key in the leaf we found
		  if(node.keys==1) {
			  if(key<node.key1) {
				  node.key2=node.key1;
				  node.key1=key;
