...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
	  ...
	  if (array[root2] < array[root1]) {                 // root2 has larger tree
		  ...
		  System.err.println("These integers are not roots or they are identical! Check again!");
	  }
  }
  /**
   *  check if root1 and root2 is identical and whether they are the Root or not
   * @param root1 is the import integer from array 1
   * @param root2 is the import integer from array 1
   * @return true if they are different and they are both the roots.
   */
  private boolean errorCheck(int root1, int root2) {
